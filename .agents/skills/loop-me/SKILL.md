...
Run a stateful `/grilling` session whose only output is **workflow** specs. Use the grilling discipline — relentless frontier batches, a recommended answer on each question — aimed at the vocabulary and goal below. Create, edit, and delete specs as the grilling resolves things.
